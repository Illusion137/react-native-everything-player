                    ...
                    when (val entry = metadata[i]) {
                        ...
                        is TextInformationFrame -> {
                            ...
                            when (entry.id.uppercase()) {
                                "TIT2", "TT2" -> { putString("title", entry.values[0]); rawEntry.putString("commonKey", "title") }
                                "TALB", "TOAL", "TAL" -> { putString("albumName", entry.values[0]); rawEntry.putString("commonKey", "albumName") }
                                "TOPE", "TPE1", "TP1" -> { putString("artist", entry.values[0]); rawEntry.putString("commonKey", "artist") }
                                "TDRC", "TOR" -> { putString("creationDate", entry.values[0]); rawEntry.putString("commonKey", "creationDate") }
                                "TCON", "TCO" -> { putString("genre", entry.values[0]); rawEntry.putString("commonKey", "genre") }
                            }
                        ...
                        is IcyHeaders -> {
                            ...
                            rawEntries.add(Bundle().apply { putString("value", entry.name); putString("commonKey", "title"); putString("key", "StreamTitle"); putString("keySpace", "icy"); putString("time", "-1") })
                            rawEntries.add(Bundle().apply { putString("value", entry.url); putString("key", "StreamURL"); putString("keySpace", "icy"); putString("time", "-1") })
                            rawEntries.add(Bundle().apply { putString("value", entry.genre); putString("commonKey", "genre"); putString("key", "StreamGenre"); putString("keySpace", "icy"); putString("time", "-1") })
                        }
                        is IcyInfo -> {
                            putString("title", entry.title)
                            rawEntries.add(Bundle().apply { putString("value", entry.url); putString("key", "StreamURL"); putString("keySpace", "icy"); putString("time", "-1") })
                            rawEntries.add(Bundle().apply { putString("value", entry.title); putString("commonKey", "title"); putString("key", "StreamTitle"); putString("keySpace", "icy"); putString("time", "-1") })
                        }
                        is VorbisComment -> {
                            val rawEntry = Bundle()
                            when (entry.key) {
                                "TITLE" -> { putString("title", entry.value); rawEntry.putString("commonKey", "title") }
                                "ARTIST" -> { putString("artist", entry.value); rawEntry.putString("commonKey", "artist") }
                                "ALBUM" -> { putString("albumName", entry.value); rawEntry.putString("commonKey", "albumName") }
                                "DATE" -> { putString("creationDate", entry.value); rawEntry.putString("commonKey", "creationDate") }
                                "GENRE" -> { putString("genre", entry.value); rawEntry.putString("commonKey", "genre") }
                                "URL" -> { putString("url", entry.value) }
                            }
                        ...
                        is MdtaMetadataEntry -> {
                            val rawEntry = Bundle()
                            when (entry.key) {
                                "com.apple.quicktime.title" -> { putString("title", entry.value.toString()); rawEntry.putString("commonKey", "title") }
                                "com.apple.quicktime.artist" -> { putString("artist", entry.value.toString()); rawEntry.putString("commonKey", "artist") }
                                "com.apple.quicktime.album" -> { putString("albumName", entry.value.toString()); rawEntry.putString("commonKey", "albumName") }
                                "com.apple.quicktime.creationdate" -> { putString("creationDate", entry.value.toString()); rawEntry.putString("commonKey", "creationDate") }
                                "com.apple.quicktime.genre" -> { putString("genre", entry.value.toString()); rawEntry.putString("commonKey", "genre") }
                            }
