...
// Forward declaration of `HybridVideoSurfaceSpec` to properly resolve imports.
namespace margelo::nitro::nitroplayer { class HybridVideoSurfaceSpec; }
...
// Forward declaration of `SabrDownloadProgress` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct SabrDownloadProgress; }
...
// Forward declaration of `SabrRefreshPoTokenRequest` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct SabrRefreshPoTokenRequest; }
// Forward declaration of `SabrReloadPlayerResponseRequest` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct SabrReloadPlayerResponseRequest; }
...
// Forward declaration of `TrackDrmConfig` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct TrackDrmConfig; }
...
// Forward declaration of `WidevineConfig` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct WidevineConfig; }
...
namespace margelo::nitro::nitroplayer::bridge::swift {
  ...
  // pragma MARK: std::variant<nitro::NullType, TrackDrmConfig>
  /**
   * Wrapper struct for `std::variant<nitro::NullType, TrackDrmConfig>`.
   * std::variant cannot be used in Swift because of a Swift bug.
   * Not even specializing it works. So we create a wrapper struct.
   */
  struct std__variant_nitro__NullType__TrackDrmConfig_ final {
    std::variant<nitro::NullType, TrackDrmConfig> variant;
    std__variant_nitro__NullType__TrackDrmConfig_(std::variant<nitro::NullType, TrackDrmConfig> variant): variant(variant) { }
    operator std::variant<nitro::NullType, TrackDrmConfig>() const noexcept {
      return variant;
    }
    inline size_t index() const noexcept {
      return variant.index();
    ...
    inline TrackDrmConfig get_1() const noexcept {
      return std::get<1>(variant);
    }
  };
  inline std__variant_nitro__NullType__TrackDrmConfig_ create_std__variant_nitro__NullType__TrackDrmConfig_(nitro::NullType value) noexcept {
    return std__variant_nitro__NullType__TrackDrmConfig_(value);
  }
  inline std__variant_nitro__NullType__TrackDrmConfig_ create_std__variant_nitro__NullType__TrackDrmConfig_(const TrackDrmConfig& value) noexcept {
    return std__variant_nitro__NullType__TrackDrmConfig_(value);
  }
  
  // pragma MARK: std::optional<std::variant<nitro::NullType, TrackDrmConfig>>
  /**
   * Specialized version of `std::optional<std::variant<nitro::NullType, TrackDrmConfig>>`.
   */
  using std__optional_std__variant_nitro__NullType__TrackDrmConfig__ = std::optional<std::variant<nitro::NullType, TrackDrmConfig>>;
  inline std::optional<std::variant<nitro::NullType, TrackDrmConfig>> create_std__optional_std__variant_nitro__NullType__TrackDrmConfig__(const std::variant<nitro::NullType, TrackDrmConfig>& value) noexcept {
    return std::optional<std::variant<nitro::NullType, TrackDrmConfig>>(value);
  }
  inline bool has_value_std__optional_std__variant_nitro__NullType__TrackDrmConfig__(const std::optional<std::variant<nitro::NullType, TrackDrmConfig>>& optional) noexcept {
    return optional.has_value();
  }
  inline std::variant<nitro::NullType, TrackDrmConfig> get_std__optional_std__variant_nitro__NullType__TrackDrmConfig__(const std::optional<std::variant<nitro::NullType, TrackDrmConfig>>& optional) noexcept {
    return optional.value();
  }
  ...
  // pragma MARK: std::optional<WidevineConfig>
  /**
   * Specialized version of `std::optional<WidevineConfig>`.
   */
  using std__optional_WidevineConfig_ = std::optional<WidevineConfig>;
  inline std::optional<WidevineConfig> create_std__optional_WidevineConfig_(const WidevineConfig& value) noexcept {
    return std::optional<WidevineConfig>(value);
  }
  inline bool has_value_std__optional_WidevineConfig_(const std::optional<WidevineConfig>& optional) noexcept {
    return optional.has_value();
  }
  inline WidevineConfig get_std__optional_WidevineConfig_(const std::optional<WidevineConfig>& optional) noexcept {
    return optional.value();
  }
  ...
  // pragma MARK: std::optional<SabrContainer>
  /**
   * Specialized version of `std::optional<SabrContainer>`.
   */
  using std__optional_SabrContainer_ = std::optional<SabrContainer>;
  inline std::optional<SabrContainer> create_std__optional_SabrContainer_(const SabrContainer& value) noexcept {
    return std::optional<SabrContainer>(value);
  }
  inline bool has_value_std__optional_SabrContainer_(const std::optional<SabrContainer>& optional) noexcept {
    return optional.has_value();
  }
  inline SabrContainer get_std__optional_SabrContainer_(const std::optional<SabrContainer>& optional) noexcept {
    return optional.value();
  }
  
  // pragma MARK: std::vector<SabrFormat>
  /**
   * Specialized version of `std::vector<SabrFormat>`.
   */
  using std__vector_SabrFormat_ = std::vector<SabrFormat>;
  inline std::vector<SabrFormat> create_std__vector_SabrFormat_(size_t size) noexcept {
    std::vector<SabrFormat> vector;
    vector.reserve(size);
    return vector;
  }
  
  // pragma MARK: std::optional<std::vector<SabrFormat>>
  /**
   * Specialized version of `std::optional<std::vector<SabrFormat>>`.
   */
  using std__optional_std__vector_SabrFormat__ = std::optional<std::vector<SabrFormat>>;
  inline std::optional<std::vector<SabrFormat>> create_std__optional_std__vector_SabrFormat__(const std::vector<SabrFormat>& value) noexcept {
    return std::optional<std::vector<SabrFormat>>(value);
  }
  inline bool has_value_std__optional_std__vector_SabrFormat__(const std::optional<std::vector<SabrFormat>>& optional) noexcept {
    return optional.has_value();
  }
  inline std::vector<SabrFormat> get_std__optional_std__vector_SabrFormat__(const std::optional<std::vector<SabrFormat>>& optional) noexcept {
    return optional.value();
  }
  
  // pragma MARK: std::optional<SabrClientInfo>
  /**
   * Specialized version of `std::optional<SabrClientInfo>`.
   */
  using std__optional_SabrClientInfo_ = std::optional<SabrClientInfo>;
  inline std::optional<SabrClientInfo> create_std__optional_SabrClientInfo_(const SabrClientInfo& value) noexcept {
    return std::optional<SabrClientInfo>(value);
  }
  inline bool has_value_std__optional_SabrClientInfo_(const std::optional<SabrClientInfo>& optional) noexcept {
    return optional.has_value();
  }
  inline SabrClientInfo get_std__optional_SabrClientInfo_(const std::optional<SabrClientInfo>& optional) noexcept {
    return optional.value();
  }
  
  // pragma MARK: std::function<void(const SabrDownloadProgress& /* progress */)>
  /**
   * Specialized version of `std::function<void(const SabrDownloadProgress&)>`.
   */
  using Func_void_SabrDownloadProgress = std::function<void(const SabrDownloadProgress& /* progress */)>;
  /**
   * Wrapper class for a `std::function<void(const SabrDownloadProgress& / * progress * /)>`, this can be used from Swift.
   */
  class Func_void_SabrDownloadProgress_Wrapper final {
  public:
    explicit Func_void_SabrDownloadProgress_Wrapper(std::function<void(const SabrDownloadProgress& /* progress */)>&& func): _function(std::make_unique<std::function<void(const SabrDownloadProgress& /* progress */)>>(std::move(func))) {}
    inline void call(SabrDownloadProgress progress) const noexcept {
      _function->operator()(progress);
    }
  private:
    std::unique_ptr<std::function<void(const SabrDownloadProgress& /* progress */)>> _function;
  } SWIFT_NONCOPYABLE;
  Func_void_SabrDownloadProgress create_Func_void_SabrDownloadProgress(void* NON_NULL swiftClosureWrapper) noexcept;
  inline Func_void_SabrDownloadProgress_Wrapper wrap_Func_void_SabrDownloadProgress(Func_void_SabrDownloadProgress value) noexcept {
    return Func_void_SabrDownloadProgress_Wrapper(std::move(value));
  }
  
  // pragma MARK: std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>
  /**
   * Specialized version of `std::function<void(const SabrReloadPlayerResponseRequest&)>`.
   */
  using Func_void_SabrReloadPlayerResponseRequest = std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>;
  /**
   * Wrapper class for a `std::function<void(const SabrReloadPlayerResponseRequest& / * request * /)>`, this can be used from Swift.
   */
  class Func_void_SabrReloadPlayerResponseRequest_Wrapper final {
  public:
    explicit Func_void_SabrReloadPlayerResponseRequest_Wrapper(std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>&& func): _function(std::make_unique<std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>>(std::move(func))) {}
    inline void call(SabrReloadPlayerResponseRequest request) const noexcept {
      _function->operator()(request);
    }
  private:
    std::unique_ptr<std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>> _function;
  } SWIFT_NONCOPYABLE;
  Func_void_SabrReloadPlayerResponseRequest create_Func_void_SabrReloadPlayerResponseRequest(void* NON_NULL swiftClosureWrapper) noexcept;
  inline Func_void_SabrReloadPlayerResponseRequest_Wrapper wrap_Func_void_SabrReloadPlayerResponseRequest(Func_void_SabrReloadPlayerResponseRequest value) noexcept {
    return Func_void_SabrReloadPlayerResponseRequest_Wrapper(std::move(value));
  }
  
  // pragma MARK: std::function<void(const SabrRefreshPoTokenRequest& /* request */)>
  /**
   * Specialized version of `std::function<void(const SabrRefreshPoTokenRequest&)>`.
   */
  using Func_void_SabrRefreshPoTokenRequest = std::function<void(const SabrRefreshPoTokenRequest& /* request */)>;
  /**
   * Wrapper class for a `std::function<void(const SabrRefreshPoTokenRequest& / * request * /)>`, this can be used from Swift.
   */
  class Func_void_SabrRefreshPoTokenRequest_Wrapper final {
  public:
    explicit Func_void_SabrRefreshPoTokenRequest_Wrapper(std::function<void(const SabrRefreshPoTokenRequest& /* request */)>&& func): _function(std::make_unique<std::function<void(const SabrRefreshPoTokenRequest& /* request */)>>(std::move(func))) {}
    inline void call(SabrRefreshPoTokenRequest request) const noexcept {
      _function->operator()(request);
    }
  private:
    std::unique_ptr<std::function<void(const SabrRefreshPoTokenRequest& /* request */)>> _function;
  } SWIFT_NONCOPYABLE;
  Func_void_SabrRefreshPoTokenRequest create_Func_void_SabrRefreshPoTokenRequest(void* NON_NULL swiftClosureWrapper) noexcept;
  inline Func_void_SabrRefreshPoTokenRequest_Wrapper wrap_Func_void_SabrRefreshPoTokenRequest(Func_void_SabrRefreshPoTokenRequest value) noexcept {
    return Func_void_SabrRefreshPoTokenRequest_Wrapper(std::move(value));
  }
  ...
  // pragma MARK: std::shared_ptr<HybridVideoSurfaceSpec>
  /**
   * Specialized version of `std::shared_ptr<HybridVideoSurfaceSpec>`.
   */
  using std__shared_ptr_HybridVideoSurfaceSpec_ = std::shared_ptr<HybridVideoSurfaceSpec>;
  std::shared_ptr<HybridVideoSurfaceSpec> create_std__shared_ptr_HybridVideoSurfaceSpec_(void* NON_NULL swiftUnsafePointer) noexcept;
  void* NON_NULL get_std__shared_ptr_HybridVideoSurfaceSpec_(std__shared_ptr_HybridVideoSurfaceSpec_ cppType);
  
  // pragma MARK: std::weak_ptr<HybridVideoSurfaceSpec>
  using std__weak_ptr_HybridVideoSurfaceSpec_ = std::weak_ptr<HybridVideoSurfaceSpec>;
  inline std__weak_ptr_HybridVideoSurfaceSpec_ weakify_std__shared_ptr_HybridVideoSurfaceSpec_(const std::shared_ptr<HybridVideoSurfaceSpec>& strong) noexcept { return strong; }
  
  // pragma MARK: Result<VideoSurfaceState>
  using Result_VideoSurfaceState_ = Result<VideoSurfaceState>;
  inline Result_VideoSurfaceState_ create_Result_VideoSurfaceState_(const VideoSurfaceState& value) noexcept {
    return Result<VideoSurfaceState>::withValue(value);
  }
  inline Result_VideoSurfaceState_ create_Result_VideoSurfaceState_(const std::exception_ptr& error) noexcept {
    return Result<VideoSurfaceState>::withError(error);
  }
