...
#include "HybridVideoSurfaceSpecSwift.hpp"
...
namespace margelo::nitro::nitroplayer::bridge::swift {
  ...
  Func_void_SabrDownloadProgress create_Func_void_SabrDownloadProgress(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroPlayer::Func_void_SabrDownloadProgress::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const SabrDownloadProgress& progress) mutable -> void {
      swiftClosure.call(progress);
    };
  }
  ...
  Func_void_SabrReloadPlayerResponseRequest create_Func_void_SabrReloadPlayerResponseRequest(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroPlayer::Func_void_SabrReloadPlayerResponseRequest::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const SabrReloadPlayerResponseRequest& request) mutable -> void {
      swiftClosure.call(request);
    };
  }
  ...
  Func_void_SabrRefreshPoTokenRequest create_Func_void_SabrRefreshPoTokenRequest(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroPlayer::Func_void_SabrRefreshPoTokenRequest::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const SabrRefreshPoTokenRequest& request) mutable -> void {
      swiftClosure.call(request);
    };
  }
  ...
  std::shared_ptr<HybridVideoSurfaceSpec> create_std__shared_ptr_HybridVideoSurfaceSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    NitroPlayer::HybridVideoSurfaceSpec_cxx swiftPart = NitroPlayer::HybridVideoSurfaceSpec_cxx::fromUnsafe(swiftUnsafePointer);
    return std::make_shared<margelo::nitro::nitroplayer::HybridVideoSurfaceSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridVideoSurfaceSpec_(std__shared_ptr_HybridVideoSurfaceSpec_ cppType) {
    std::shared_ptr<margelo::nitro::nitroplayer::HybridVideoSurfaceSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::nitroplayer::HybridVideoSurfaceSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridVideoSurfaceSpec\" is not implemented in Swift!");
    }
    #endif
    NitroPlayer::HybridVideoSurfaceSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
