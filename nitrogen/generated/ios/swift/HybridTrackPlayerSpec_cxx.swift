...
open class HybridTrackPlayerSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridTrackPlayerSpec_cxx) -> Bool {
  ...
  @inline(__always)
  public final func downloadSabr(params: SabrDownloadParams, outputPath: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.downloadSabr(params: params, outputPath: String(outputPath))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func updateSabrStream(outputPath: std.string, sabrServerUrl: std.string, sabrUstreamerConfig: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.updateSabrStream(outputPath: String(outputPath), sabrServerUrl: String(sabrServerUrl), sabrUstreamerConfig: String(sabrUstreamerConfig))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func updateSabrPoToken(outputPath: std.string, poToken: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.updateSabrPoToken(outputPath: String(outputPath), poToken: String(poToken))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func onSabrDownloadProgress(callback: bridge.Func_void_SabrDownloadProgress) -> bridge.Result_void_ {
    do {
      try self.__implementation.onSabrDownloadProgress(callback: { () -> (SabrDownloadProgress) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_SabrDownloadProgress(callback)
        return { (__progress: SabrDownloadProgress) -> Void in
  ...
  @inline(__always)
  public final func onSabrReloadPlayerResponse(callback: bridge.Func_void_SabrReloadPlayerResponseRequest) -> bridge.Result_void_ {
    do {
      try self.__implementation.onSabrReloadPlayerResponse(callback: { () -> (SabrReloadPlayerResponseRequest) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_SabrReloadPlayerResponseRequest(callback)
        return { (__request: SabrReloadPlayerResponseRequest) -> Void in
          __wrappedFunction.call(__request)
        }
      }())
      return bridge.create_Result_void_()
    } catch (let __error) {
  ...
  @inline(__always)
  public final func onSabrRefreshPoToken(callback: bridge.Func_void_SabrRefreshPoTokenRequest) -> bridge.Result_void_ {
    do {
      try self.__implementation.onSabrRefreshPoToken(callback: { () -> (SabrRefreshPoTokenRequest) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_SabrRefreshPoTokenRequest(callback)
        return { (__request: SabrRefreshPoTokenRequest) -> Void in
          __wrappedFunction.call(__request)
        }
      }())
      return bridge.create_Result_void_()
  ...
  @inline(__always)
  public final func isWidevineSupported() -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.isWidevineSupported()
      let __resultCpp = __result
      return bridge.create_Result_bool_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
  ...
  @inline(__always)
  public final func setCrossfadeDuration(seconds: Double) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.setCrossfadeDuration(seconds: seconds)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func getCrossfadeDuration() -> bridge.Result_std__shared_ptr_Promise_double___ {
    do {
      let __result = try self.__implementation.getCrossfadeDuration()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_double__ in
        let __promise = bridge.create_std__shared_ptr_Promise_double__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_double__(__promise)
        __result
