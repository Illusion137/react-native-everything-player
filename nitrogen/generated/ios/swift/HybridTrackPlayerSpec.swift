...
public protocol HybridTrackPlayerSpec_protocol: HybridObject {
  ...
  func onSabrDownloadProgress(callback: @escaping (_ progress: SabrDownloadProgress) -> Void) throws -> Void
  func onSabrReloadPlayerResponse(callback: @escaping (_ request: SabrReloadPlayerResponseRequest) -> Void) throws -> Void
  func onSabrRefreshPoToken(callback: @escaping (_ request: SabrRefreshPoTokenRequest) -> Void) throws -> Void
  func isWidevineSupported() throws -> Bool
