///
/// Variant_NullType_TrackDrmConfig.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_TrackDrmConfig {
  case first(NullType)
  case second(TrackDrmConfig)
}

public extension Variant_NullType_TrackDrmConfig {
