...
// Forward declaration of `SabrDownloadParams` to properly resolve imports.
namespace margelo::nitro::nitroplayer { struct SabrDownloadParams; }
...
#include "JSabrDownloadParams.hpp"
...
namespace margelo::nitro::nitroplayer {
  ...
  std::shared_ptr<Promise<void>> JHybridTrackPlayerSpec::downloadSabr(const SabrDownloadParams& params, const std::string& outputPath) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JSabrDownloadParams> /* params */, jni::alias_ref<jni::JString> /* outputPath */)>("downloadSabr");
    auto __result = method(_javaPart, JSabrDownloadParams::fromCpp(params), jni::make_jstring(outputPath));
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
        __promise->resolve();
  ...
  std::shared_ptr<Promise<void>> JHybridTrackPlayerSpec::updateSabrStream(const std::string& outputPath, const std::string& sabrServerUrl, const std::string& sabrUstreamerConfig) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* outputPath */, jni::alias_ref<jni::JString> /* sabrServerUrl */, jni::alias_ref<jni::JString> /* sabrUstreamerConfig */)>("updateSabrStream");
    auto __result = method(_javaPart, jni::make_jstring(outputPath), jni::make_jstring(sabrServerUrl), jni::make_jstring(sabrUstreamerConfig));
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
        __promise->resolve();
  ...
  std::shared_ptr<Promise<void>> JHybridTrackPlayerSpec::updateSabrPoToken(const std::string& outputPath, const std::string& poToken) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* outputPath */, jni::alias_ref<jni::JString> /* poToken */)>("updateSabrPoToken");
    auto __result = method(_javaPart, jni::make_jstring(outputPath), jni::make_jstring(poToken));
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
        __promise->resolve();
  ...
  void JHybridTrackPlayerSpec::onSabrDownloadProgress(const std::function<void(const SabrDownloadProgress& /* progress */)>& callback) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_SabrDownloadProgress::javaobject> /* callback */)>("onSabrDownloadProgress_cxx");
    method(_javaPart, JFunc_void_SabrDownloadProgress_cxx::fromCpp(callback));
  }
  void JHybridTrackPlayerSpec::onSabrReloadPlayerResponse(const std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>& callback) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_SabrReloadPlayerResponseRequest::javaobject> /* callback */)>("onSabrReloadPlayerResponse_cxx");
    method(_javaPart, JFunc_void_SabrReloadPlayerResponseRequest_cxx::fromCpp(callback));
  }
  void JHybridTrackPlayerSpec::onSabrRefreshPoToken(const std::function<void(const SabrRefreshPoTokenRequest& /* request */)>& callback) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_SabrRefreshPoTokenRequest::javaobject> /* callback */)>("onSabrRefreshPoToken_cxx");
    method(_javaPart, JFunc_void_SabrRefreshPoTokenRequest_cxx::fromCpp(callback));
  }
  bool JHybridTrackPlayerSpec::isWidevineSupported() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jboolean()>("isWidevineSupported");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  std::shared_ptr<Promise<void>> JHybridTrackPlayerSpec::setCrossfadeDuration(double seconds) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(double /* seconds */)>("setCrossfadeDuration");
  ...
  std::shared_ptr<Promise<double>> JHybridTrackPlayerSpec::getCrossfadeDuration() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("getCrossfadeDuration");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<double>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
