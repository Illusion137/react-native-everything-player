...
namespace margelo::nitro::nitroplayer {
  ...
  public:
    ...
    std::shared_ptr<Promise<void>> downloadSabr(const SabrDownloadParams& params, const std::string& outputPath) override;
    std::shared_ptr<Promise<void>> updateSabrStream(const std::string& outputPath, const std::string& sabrServerUrl, const std::string& sabrUstreamerConfig) override;
    std::shared_ptr<Promise<void>> updateSabrPoToken(const std::string& outputPath, const std::string& poToken) override;
    void onSabrDownloadProgress(const std::function<void(const SabrDownloadProgress& /* progress */)>& callback) override;
    void onSabrReloadPlayerResponse(const std::function<void(const SabrReloadPlayerResponseRequest& /* request */)>& callback) override;
    void onSabrRefreshPoToken(const std::function<void(const SabrRefreshPoTokenRequest& /* request */)>& callback) override;
    bool isWidevineSupported() override;
    std::shared_ptr<Promise<void>> setCrossfadeDuration(double seconds) override;
    std::shared_ptr<Promise<double>> getCrossfadeDuration() override;
