...
namespace margelo::nitro::everythingplayer {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/everythingplayer/Variant_NullType_AnyMap;";
  ...
  namespace JVariant_NullType_AnyMap_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/everythingplayer/Variant_NullType_AnyMap$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/everythingplayer/Variant_NullType_AnyMap$Second;";
