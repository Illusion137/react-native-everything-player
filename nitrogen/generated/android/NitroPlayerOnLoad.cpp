...
void registerAllNatives() {
  ...
  margelo::nitro::nitroplayer::JFunc_void_SabrDownloadProgress_cxx::registerNatives();
  margelo::nitro::nitroplayer::JFunc_void_SabrReloadPlayerResponseRequest_cxx::registerNatives();
  margelo::nitro::nitroplayer::JFunc_void_SabrRefreshPoTokenRequest_cxx::registerNatives();
  margelo::nitro::nitroplayer::JHybridVideoSurfaceSpec::CxxPart::registerNatives();
